...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "AtWave Request Session ID",
  "description": "The request session id used by AtWave.",
  "containerContexts": [
    "WEB"
  ]
}
...
// Get session Ids if available
  ...
  const requestSessionId = sessionLocalStorageID || sessionCookieID;
...
Created on 10/28/2021, 1:06:48 PM
